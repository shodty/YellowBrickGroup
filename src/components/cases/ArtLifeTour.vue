<template lang="pug">
#alt-main
    CaseLeft(caseTitle='ART LIFE TOUR' year='2018' :pattern='patterns.artlife')
        p(slot="description") 
    ...
    CaseRight
        ...
        video(class='case-image' slot='image2' alt='art-life-tour2' src='../../assets/img/cases/alt/2.mp4' id='art-life-tour2' controls autoplay muted loop)
